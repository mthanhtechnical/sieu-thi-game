...
Mở <http://localhost:4173/kho-game/>.
...
<https://sieu-thi-game.pages.dev/analytics.html>
...
<https://sieu-thi-game.pages.dev/kids/>
...
```bash
npx wrangler pages deploy . --project-name=sieu-thi-game
```
