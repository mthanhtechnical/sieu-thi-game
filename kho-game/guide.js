(function () {
  const guides = {
    ...
    "picture-vocabulary": {title:"Picture Vocabulary",steps:[["Nhìn hình","Quan sát hình đại diện và đọc từ tiếng Anh."],["Nghe phát âm","Bấm nút loa để nghe cách đọc."],["Chọn nghĩa","Chọn nghĩa tiếng Việt đúng trong 4 đáp án."],["Giữ combo","Trả lời đúng liên tiếp để tăng điểm."]],tip:"Mẹo: đọc to từ sau khi nghe để nhớ cả hình, nghĩa và âm."},
    "emoji-vocabulary": {title:"Emoji Vocabulary",steps:[["Nhìn emoji","Dùng emoji để liên tưởng chủ đề của từ."],["Đọc từ","Quan sát từ tiếng Anh đi kèm."],["Chọn nghĩa","Chọn nghĩa tiếng Việt chính xác."],["Nghe lại","Bấm loa để luyện phát âm."]],tip:"Mẹo: tự nghĩ thêm một emoji khác liên quan tới từ."},
    "grammar-quiz": {title:"Grammar Quiz",steps:[["Đọc từ khóa","Mỗi câu dùng một từ khác nhau trong kho 1.000 mục."],["So sánh câu","Tìm điểm khác nhau giữa 4 cấu trúc."],["Chọn câu đúng","Chỉ một câu đúng ngữ pháp."],["Xem đáp án","Đọc lại câu đúng sau khi trả lời."]],tip:"Mẹo: kiểm tra chủ ngữ, động từ và dạng V-ing/to V."},
    "sentence-builder": {title:"Sentence Builder",steps:[["Đọc từ khóa","Từ vựng cần dùng hiện trên thẻ."],["Chọn từng từ","Bấm các mảnh theo thứ tự câu."],["Hoàn thành câu","Game kiểm tra khi bạn dùng hết các mảnh."],["Nghe từ","Bấm loa để nghe phát âm từ khóa."]],tip:"Mẹo: tìm chủ ngữ trước, sau đó đến động từ và phần bổ nghĩa."},
    listening:{title:"Listening",steps:[["Bấm nghe","Nghe từ tiếng Anh nhưng không nhìn đáp án."],["Nghe lại","Có thể bấm loa nhiều lần."],["Chọn nghĩa","Chọn nghĩa tiếng Việt tương ứng."],["Giữ combo","Nghe đúng liên tiếp để tăng điểm."]],tip:"Mẹo: tập trung vào âm đầu, trọng âm và âm cuối."},
    reading:{title:"Reading",steps:[["Đọc đoạn ngắn","Mỗi câu có một đoạn tiếng Anh ngắn."],["Tìm thông tin","Xác định từ được nhắc đến trong đoạn."],["Chọn đáp án","Trả lời câu hỏi đọc hiểu."],["Nghe phát âm","Bấm loa để nghe từ trọng tâm."]],tip:"Mẹo: đọc câu hỏi trước rồi quay lại tìm thông tin trong đoạn."},
    typing:{title:"Typing",steps:[["Đọc nghĩa","Mỗi câu cho một nghĩa tiếng Việt."],["Nghe từ","Bấm loa nếu muốn luyện nghe-chép."],["Gõ đáp án","Nhập chính xác từ tiếng Anh."],["Nhấn Enter","Gửi nhanh đáp án bằng bàn phím."]],tip:"Mẹo: đọc lại từng chữ trước khi gửi để tránh lỗi chính tả."},
    "daily-challenge":{title:"Daily Challenge",steps:[["Bộ câu mỗi ngày","Mọi người nhận cùng một bộ câu theo ngày."],["Chọn nghĩa","Trả lời 10 câu từ vựng."],["Giữ combo","Đúng liên tiếp giúp tăng điểm."],["Quay lại ngày mai","Ngày mới sẽ có bộ thử thách khác."]],tip:"Mẹo: chơi một lượt thật tập trung để lập điểm ngày cao."},
    "60s-challenge":{title:"60s Challenge",steps:[["Có 60 giây","Đồng hồ bắt đầu khi vào game."],["Chọn thật nhanh","Mỗi đáp án xong sẽ tự sang câu mới."],["Giữ chính xác","Combo giúp điểm tăng nhanh hơn."],["Chơi đến hết giờ","Trả lời được càng nhiều càng tốt."]],tip:"Mẹo: nếu phân vân lâu, chọn đáp án hợp lý nhất để giữ nhịp."},
    "quiz-theo-chu-de": {
  ...
  function slugFromPath() {
    ...
    if (!parts.length || last === "kho-game") return "portal";
    return last;
  }
  ...
  function getGameInfo() {
    ...
    const titles = {
      ...
      "picture-vocabulary":"Picture Vocabulary","emoji-vocabulary":"Emoji Vocabulary","grammar-quiz":"Grammar Quiz","sentence-builder":"Sentence Builder",listening:"Listening",reading:"Reading",typing:"Typing","daily-challenge":"Daily Challenge","60s-challenge":"60s Challenge",
      wordle: "Wordle",
      hangman: "Hangman",
    ...
    const descriptions = {
      ...
      "picture-vocabulary":"Nhìn hình và chọn nghĩa đúng.","emoji-vocabulary":"Học từ vựng qua emoji.","grammar-quiz":"Chọn câu tiếng Anh đúng ngữ pháp.","sentence-builder":"Sắp xếp từ thành câu hoàn chỉnh.",listening:"Nghe từ và chọn nghĩa đúng.",reading:"Đọc đoạn ngắn và trả lời câu hỏi.",typing:"Gõ chính xác từ tiếng Anh.","daily-challenge":"Thử thách tiếng Anh mới mỗi ngày.","60s-challenge":"Đua điểm tiếng Anh trong 60 giây.",
  ...
  function hookScoreRecording(slug) {
    if (window.recordGameScore?.uxSummaryWrapped) return;
    const originalRecord = typeof window.recordGameScore === "function" ? window.recordGameScore : null;
    const wrappedRecord = function recordGameScore(gameName, score, emoji) {
    ...
    wrappedRecord.uxSummaryWrapped = true;
    window.recordGameScore = wrappedRecord;
  }
  ...
  function renderSharedSummary() {
    ...
    let hubData = null;
    try { hubData = JSON.parse(localStorage.getItem("emoji_game_hub_data") || "null"); } catch (_) {}
    const gameHistory = hubData?.gamesLeaderboard?.[game.title] || [];
    const recentGame = hubData?.recentGames?.find((entry) => entry.gameName === game.title);
    const bestScore = getBestScoreForGame(game.slug);
    const playCount = Math.max(getPlayCountForGame(game.slug), gameHistory.length);
    const lastScore = localStorage.getItem(`ux-last-score:${game.slug}`) || (recentGame ? `${recentGame.score} điểm` : "—");
